...
class LowerStatusCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'accounting-system:lower-order {id}';
     ...
     * @var string
     */
    protected $description = 'Lower order status';
    ...
    public function handle(OrderServiceContract $orderService)
    {
        ...
        try {
            $order = $orderService->lowerStatus($orderId);
